    ...
    <div class="container p-8 gap-8 w-full">
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg p-4">
            ...
            <form action="./admin_editar_producto.php" method="POST">
                ...
                <textarea id="especificaciones" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Especificaciones..." value="<?= $producto['especificaciones'] ?>" />
